...
public class HeartsHealthVisual : MonoBehaviour {
    ...
    private void Start() {
        ...
        health = player.GetComponent<PlayerHandler>().hearthNumber;
        HeartsHealthSystem heartsHealthSys = new HeartsHealthSystem(health);
        SetHeartsHealthSystem(heartsHealthSys);
    ...
    private HeartImage CreateHeartImage(Vector2 anchoredPosition) {
        ...
        heartGameObject.GetComponent<Animation>().AddClip(heartFullAnimationClip, "heart-full-scarboni");
    ...
    public class HeartImage {
        ...
        public void SetHeartFraments(int fragments) {
            ...
            switch (fragments) {
                case 0: heartImage.sprite = heartsHealthVisual.heartSpriteEmpty; break;
                case 1: heartImage.sprite = heartsHealthVisual.heartSpriteQuarter; break;
                case 2: heartImage.sprite = heartsHealthVisual.heartSpriteHalf; break;
                case 3: heartImage.sprite = heartsHealthVisual.heartSpriteThreeQuarter; break;
                case 4: heartImage.sprite = heartsHealthVisual.heartSpriteFull; break;
            }
        }
        ...
        public void PlayHeartFullAnimation() {
            animation.Play("heart-full-scarboni", PlayMode.StopAll);
        }
}
